class ApiEndpoints {
  ...
  static const String searchProductByName = 'product/search';
  ...
  static const String updateCartStatus = 'cart/update_status';
...
// ===========Wishlist Routes===========
  ...
  static const String updateStatusApi = 'cart/update_status';

  // ===========Payment Routes===========
  static const String initlizePayment = 'khalti/initialize-khalti';
  static const String verifyPayment = 'khalti/verify-khalti-payment';
}
